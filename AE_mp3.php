...
function AE_mp3_load(){
	echo '<link href="'.BLOG_URL.'content/plugins/AE_mp3/style/player.css" rel="stylesheet" type="text/css">'."\n";
...
<script language="javascript" src="<?php echo BLOG_URL;?>content/plugins/AE_mp3/js/mousewheel.js"></script>
<script language="javascript" src="<?php echo BLOG_URL;?>content/plugins/AE_mp3/js/scrollbar.js"></script>
<script language="javascript" src="<?php echo BLOG_URL;?>content/plugins/AE_mp3/js/player.js"></script>

<?php
}
function AE_mp3_menu() {
  echo '<div class="sidebarsubmenu" id="AE_mp3"><a href="./plugin.php?plugin=AE_mp3">墨渊音乐播放器</a></div>';
}
addAction('index_head', 'AE_mp3_load');
addAction('index_footer', 'AE_mp3_list');
addAction('adm_sidebar_ext', 'AE_mp3_menu');